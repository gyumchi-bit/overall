...
// MBTI Type Colors for easy access - Updated with new palette
const mbtiColors = {
    INTJ: "#45769E", INTP: "#75C9E3", ENTJ: "#288990", ENTP: "#A5C5C2",
    INFJ: "#FFB629", INFP: "#45769E", ENFJ: "#75C9E3", ENFP: "#288990",
    ISTJ: "#A5C5C2", ISFJ: "#FFB629", ESTJ: "#45769E", ESFJ: "#75C9E3",
    ISTP: "#288990", ISFP: "#A5C5C2", ESTP: "#FFB629", ESFP: "#45769E"
};

// Get dimension description
function getDimensionDescription(dimension, preference) {
    const descriptions = {
        EI: {
    ...
    return descriptions[dimension] ? descriptions[dimension][preference] || '' : '';
}